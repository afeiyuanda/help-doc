...
2. 选择您感兴趣的分析平台
    ...
    ![app_list](https://img.biocloud.net/docs/workflow-on-bmkcloud/quick-use-workflow/app_list.png)
3. 以`真核生物有参考基因组的转录组分析平台`为例演示

    打开该分析平台后，点击`运行软件`，进入分析平台之后，我们可以参考本文档快速进行体验，也可以参考[快速体验](get-started/quick-start.md)开始分析自己的数据。
    ![ref_run](https://img.biocloud.net/docs/workflow-on-bmkcloud/quick-use-workflow/ref_run.png)
4. 选择示例数据并提交任务

    该平台目前提供了4套示例数据，均选自已发表的文章，我们已经提前下载原始数据并用平台进行了分析，点击选择其中一个示例数据后，所有参数会快速添加上，如下图：
    ![select_tiyan_data](https://img.biocloud.net/docs/workflow-on-bmkcloud/quick-use-workflow/select_tiyan_data.png)
   ...
   ![change_parameter](https://img.biocloud.net/docs/workflow-on-bmkcloud/quick-use-workflow/change_parameter.png)
5. 查看项目
    ...
    ![jisu_project](https://img.biocloud.net/docs/workflow-on-bmkcloud/quick-use-workflow/jisu_project.png)
6. 查看报告
    ...
    ![jisu_report](https://img.biocloud.net/docs/workflow-on-bmkcloud/quick-use-workflow/jisu_report.png)
7. 体验个性化
    ...
    ![input_parameter](https://img.biocloud.net/docs/workflow-on-bmkcloud/quick-use-workflow/input_parameter.png)
    
    任务运行后的结果页面：
    ![personal_result1](https://img.biocloud.net/docs/workflow-on-bmkcloud/quick-use-workflow/personal_result1.png)
    
    图片交互页面，可以点击柱子筛选出对应的基因列表：
    ![interactive_img](https://img.biocloud.net/docs/workflow-on-bmkcloud/quick-use-workflow/interactive_img.png)
